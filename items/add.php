...
<head>
    ...
    <title>Add creature or plant</title>
</head>
<body>
<div class="container">
    <h1>Add creature or plant</h1>
    <form method="POST" action="add.php">
        ...
        <div class="form-group">
            ...
            <input type="text" id="length" name="lengte" required>
        </div>
        <div class="form-group">
            <label for="lived">Lived:</label>
            <input type="text" id="lived" name="geleefd" required>
        </div>
        <div class="form-group">
